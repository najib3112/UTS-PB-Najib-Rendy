...
import com.example.rejibstore.Helper.ChangeNumberItemsListener;
import com.example.rejibstore.Helper.ManagmentCart;
import com.example.rejibstore.databinding.ViewholderCartBinding;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder, int position) {
        ...
        holder.binding.totalEachItem.setText("Rp" + Math.round((listItemSelected.get(position).getNumberinCart() *
